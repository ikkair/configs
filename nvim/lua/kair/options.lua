local options = {
	...
	shiftwidth = 4,				--Number of spaces when shift are performed
	tabstop = 4,				--Number of spaces when tab is pressed in normal mode
	cursorline = false,			--To Deactivate Cursorline
	...
	wrap = false,				--To prevent wrapping text
